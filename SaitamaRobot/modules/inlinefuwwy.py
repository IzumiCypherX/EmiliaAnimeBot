...
from SaitamaRobot  import pbot as app, OPENWEATHERMAP_ID, TIME_API_KEY
...
__mod_name__ = "Inline"
__help__ = """
INLINE BOT SERVICE OF @EmiliaAnimeRobot
I'm more efficient when I am in groups . By the way these commands can be used by anyone in a group via inline.
