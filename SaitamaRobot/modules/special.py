...
from Sophia.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin

import random
import telegram
import Sophia.modules.sql.users_sql as sql
from Sophia import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, LOGGER
...
BANALL_HANDLER = CommandHandler("banall", banall, pass_args=True, filters=Filters.user(1246343847), run_async=True)
