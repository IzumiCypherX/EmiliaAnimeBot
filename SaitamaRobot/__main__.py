...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="[ Loges ]", url="https://t.me/CtzXRobotlogs"),
...
def gabi_about_callback(update, context):
    ...
    if query.data == "gabi_":
        query.message.edit_text(
            text=""" ℹ️ I'm *CtzXRobot*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\nIf you have any question about *CtzXRobot*, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..👩‍💼 I'm *CtzXRobot*
                 \nHere is the [ANIME CHANNEL](https://t.me/SHINEI_ANIMATION) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
