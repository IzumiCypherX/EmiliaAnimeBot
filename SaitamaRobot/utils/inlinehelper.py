...
from SaitamaRobot import BOT_USERNAME, OWNER_ID, pbot, arq
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/Inline-yato-07-31",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Bot", url="https://t.me/EmiliaAnimeRobot"),
